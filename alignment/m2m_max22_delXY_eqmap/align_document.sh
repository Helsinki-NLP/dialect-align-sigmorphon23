...
$M2M_EXE --inFormat news --sepChar "#" --nullChar "@" --eqMap --delX --delY --errorInFile -i $PROJECT/$FID.fwd.input -o $PROJECT/$FID.fwd.aligned --alignerOut $PROJECT/$FID.fwd.model
...
$M2M_EXE --inFormat news --sepChar "#" --nullChar "@" --eqMap --delX --delY --errorInFile -i $PROJECT/$FID.rev.input -o $PROJECT/$FID.rev.aligned --alignerOut $PROJECT/$FID.rev.model
